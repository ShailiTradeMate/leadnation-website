...
import { Globe, Compass, Newspaper, CalendarBlank, Package, Phone, List, X } from "@phosphor-icons/react";
        ...
        <div className="max-w-7xl mx-auto px-5 sm:px-8 h-[68px] flex items-center justify-between">
          <Link to="/" className="flex items-center gap-2.5 group" data-testid="nav-logo-link">
            ...
            <div className="leading-none">
              <div className="text-[15px] font-display font-extrabold tracking-tight">
                LeadNation
              </div>
          ...
          <div className="flex items-center gap-3">
            <button
              data-testid="nav-cta-create-account"
...
export function LogoMark({ size = 36 }) {
  return (
    <div
      className="relative shrink-0 grid place-items-center rounded-xl"
