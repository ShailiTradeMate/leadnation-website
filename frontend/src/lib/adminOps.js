...
export const adminOps = {
  ...
  review: (uid, payload) => staffApi.post(`/admin/users/${uid}/review`, payload, {timeout:180000}).then((r) => r.data),
  signoffQueue: () => staffApi.get("/admin/signoff").then((r) => r.data),
  signoff: (uid, payload) => staffApi.post(`/admin/users/${uid}/signoff`, payload, {timeout:180000}).then((r) => r.data),
  editProfile: (uid, patch) => staffApi.patch(`/admin/users/${uid}/profile`, { patch }, {timeout:180000}).then((r) => r.data),
  ...
  hardDelete: (uid, payload) => staffApi.post(`/admin/users/${uid}/hard-delete`, payload, {timeout:180000}).then((r) => r.data),
